...
public partial class searchresult : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SortBy = WebUtility.GetRoutingStringParameter(this.Page, "sortby", "lastmodifieddatetime");
        SortOrder = WebUtility.GetRoutingStringParameter(this.Page, "sortorder", "desc");
